...
class GCodeLogic:
    def generate(self, config, cut_paths, score_paths):
        ...
        # Split header into a title line and a timestamp line, then add a blank line after
        header_title = "; Generated by JD CNC Gcode Generator"
        header_time = f"; at {now.strftime('%H:%M:%S %d/%m/%y')}"
        header = header_title + "\n" + header_time + "\n\n"
